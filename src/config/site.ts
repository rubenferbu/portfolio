export const siteConfig = {
  ...
  credentials: [
    ...
    },
    {
      ...
      type: "openbadge" as const,
      area: "dev" as const,
      image: "https://api.verified.cv/v2/ims/image/99883654598507",
      verifyUrl: "https://api.verified.cv/v2/ims/99883654598507",
    },
    {
      id: "junior-fullstack",
      ...
      type: "openbadge" as const,
      area: "dev" as const,
      image: "https://api.verified.cv/v2/ims/image/83210350369441",
      verifyUrl: "https://api.verified.cv/v2/ims/83210350369441",
    },
  ],
} as const;